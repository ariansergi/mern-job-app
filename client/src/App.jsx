...
const isDarkThemEnabled = checkDefaultTheme()
...
const router = createBrowserRouter([
  {
    path: "/", element: <HomeLayout />, errorElement: <Error />, children: [
      ...
      {
        path: "dashboard", element: <DashboardLayout isDarkThemEnabled={isDarkThemEnabled} queryClient={queryClient} />, loader: dashboardLoader(queryClient), children: [
          {
            index: true,
            element: <AddJob />,
